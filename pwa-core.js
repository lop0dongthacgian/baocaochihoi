...
.pwa-dismiss{border:1px solid rgba(0,0,0,.12);background:rgba(0,0,0,.04);color:rgba(255, 0, 0, 1.00);}
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById('pwa-overlay').addEventListener('click', (e) => { if(e.target === document.getElementById('pwa-overlay')) document.getElementById('pwa-overlay').classList.remove('pwa-active'); });
