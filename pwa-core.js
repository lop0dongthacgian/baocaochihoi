const PWA_CONFIG = {
  APP_NAME:    'Báo cáo Công tác hội và DLXH',
  APP_DESC:    'Ứng dụng tạo báo cáo chi hội',
...
.pwa-icon-box {
  ...
  box-shadow: 0 4px 14px rgba(13,71,161,.3), 0 1px 0 rgba(255,255,255,.5) inset;
  margin: 0 auto 8px;
}
.pwa-app-name { font-size: 16px; font-weight: 800; color: ${T}; text-align: center; word-break: break-word; overflow-wrap: break-word; line-height: 1.2; max-width: 100%; hyphens: auto; }
.pwa-app-desc { font-size: 11px; color: rgba(0,0,0,.45); margin-top: 2px; text-align: center; }
.pwa-divider  { height: 1px; background: rgba(0,0,0,.08); margin: 10px 0; }
.pwa-step     { display: flex; align-items: flex-start; gap: 8px; margin-bottom: 8px; }
.pwa-step-num {
...
.pwa-step-text { font-size: 12px; color: rgba(0,0,0,.75); line-height: 1.4; }
.pwa-step-text b { color: ${T}; }
.pwa-cta-text {
  font-size: 14px; color: rgba(0,0,0,.7); margin-bottom: 12px;
  line-height: 1.4; text-align: center;
}
.pwa-warn {
  background: rgba(255,193,7,.12); border: 1px solid rgba(255,193,7,.4);
  border-radius: 10px; padding: 7px 10px;
  font-size: 11px; color: #7a5c00; font-weight: 600;
  margin-bottom: 10px;
}
#pwa-btn-install {
...
.pwa-dismiss {
  ...
  padding: 5px 14px; background: rgba(0,0,0,.04);
...
.pwa-after-note {
  margin-top: 8px; font-size: 11px; color: rgba(118, 42, 98, 1.00);
  line-height: 1.4; text-align: center;
}
`;
